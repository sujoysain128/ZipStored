...
class LocationListAdapter(private val context: Context, arrayList: ArrayList<JSONObject>) :
    androidx.recyclerview.widget.RecyclerView.Adapter<LocationListAdapter.DataObjectHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DataObjectHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.child_location, parent, false)
    ...
    override fun onBindViewHolder(holder: DataObjectHolder, position: Int) {
        ...
        holder.tv_cat_name.text = (arrayList.get(position).getString("city"))
