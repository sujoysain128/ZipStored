...
class WarehouseRulesListAdapter(private val context: Context, arrayList: ArrayList<JSONObject>) :
    androidx.recyclerview.widget.RecyclerView.Adapter<WarehouseRulesListAdapter.DataObjectHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DataObjectHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.child_warehouse_rule, parent, false)
    ...
    override fun onBindViewHolder(holder: DataObjectHolder, position: Int) {
       ...
       /* holder.tv_slot.setOnClickListener {
        ...
        (holder as DataObjectHolder).tv_rule.setText(arrayList.get(position).getString("rule_name"))
