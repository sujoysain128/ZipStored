...
class SpaceTypeListAdapter(private val context: Context, arrayList: ArrayList<JSONObject>) :
    androidx.recyclerview.widget.RecyclerView.Adapter<SpaceTypeListAdapter.DataObjectHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DataObjectHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.child_space, parent, false)
    ...
    override fun onBindViewHolder(holder: DataObjectHolder, position: Int) {
        ...
        println("SpaceListAdapter ======> " + arrayList)
        holder.tv_slot.setText(arrayList.get(position).getString("name"))
        ...
        holder.tv_slot.setOnClickListener {
            ...
            /*if (row_index == position) {
                ...
                if (itemClickListener != null) {
                    itemClickListener!!.OnItemClick("id", arrayList.get(position).getString("id"))
                }
            } else {
                holder.tv_slot.setTextColor(ContextCompat.getColor(context, R.color.gray))
                holder.tv_slot.setBackgroundDrawable(
